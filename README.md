...
This repo contains the codes and the short article as a demostration of my empirical skills which I have been self learning over the pass few months. There are 2 sections in the article: 

## Fixed Effects Regressions – Relationship between Marriage and Wages for Females
...
## Difference in Differences – Effects of Training Subsidies on Job Trainings
...
The assoicated Stata and R code for these exercises are also in the repo.
